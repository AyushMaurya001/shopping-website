...
export default function CustomerNavBar({ className }) {
  ...
  return (
    <div className={` sticky top-0 bg-card/70 backdrop-blur-sm w-full h-16 transition-all ${className}`}>
      ...
      <div className={` lg:w-[30%] w-full h-screen bg-card transition-all duration-500 absolute flex flex-col justify-start items-center ${overlayNavBarVisible===false?" -left-full":" left-0"} `}>
        ...
        <div className=' w-full h-full flex flex-col bg-card-foreground/10 border border-border'>
